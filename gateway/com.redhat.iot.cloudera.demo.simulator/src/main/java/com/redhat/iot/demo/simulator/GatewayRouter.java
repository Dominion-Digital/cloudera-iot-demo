...
*/
				...
				from("mqtt:control?host=tcp://broker-cloudera-iot-demo.svc:1883&subscribeTopicName=Red-Hat/+/" + asString(properties, "topic.prefix") + "/+/control&userName=demo-gw2&password=RedHat123")
                    .routeId("control")
                        .process(exchange -> {
...
//                                    exchange.getContext().startRoute(machine + "bad_power");
                ...
                .choice()
                    .when(header("sendOK").isNotNull())
						...
						.to("mqtt:okalert?host=tcp://broker-cloudera-iot-demo.svc:1883&userName=demo-gw2&password=RedHat123&version=3.1.1&qualityOfService=AtMostOnce");
//                .to("log:Control?showAll=true&multiline=true");
            }
        };
    }
